let data =[
    {
        brand: "Puma",
        type: "Ws AOP Tee",
        imgsrc: "/prodimg/women t-shirts/wtshirts.jpg",
        price: 1000,
        op: 1999,
        discount: 50,
        bbs: "BBS Price 750",
    },
    {
        ...
        imgsrc: "/prodimg/women t-shirts/wtshirts1.jpg",
        price: 635,
        op: 1199,
        discount: 47,
        bbs: "BBS Price 576",
    },
    {
        ...
        imgsrc: "/prodimg/women t-shirts/wtshirts2.jpg",
        price: 336,
        op: 699,
        discount: 52,
        bbs: "BBS Price 210",
    },
    {
        ...
        imgsrc: "/prodimg/women t-shirts/wtshirts3.jpg",
        price: 384,
        op: 799,
        discount: 52,
        bbs: "BBS Price 240",
    },
    {
        ...
        imgsrc: "/prodimg/women t-shirts/wtshirts4.jpg",
        price: 424,
        op: 499,
        discount: 15,
        bbs: "BBS Price 399",
    },
    {
        ...
        imgsrc: "/prodimg/women t-shirts/wtshirts5.jpg",
        price: 1749,
        op: 2499,
        discount: 30,
        bbs: "BBS Price 1574",
    },
    {
        ...
        imgsrc: "/prodimg/women t-shirts/wtshirts6.jpg",
        price: 699,
        op: 999,
        discount: 30,
        bbs: "BBS Price 629",
    },
    {
        ...
        imgsrc: "/prodimg/women t-shirts/wtshirts7.jpg",
        price: 1199,
        op: 1999,
        discount: 40,
        bbs: "BBS Price 1099",
    },
    {
        ...
        imgsrc: "/prodimg/women t-shirts/wtshirts8.jpg",
        price: 1299,
        op: 1999,
        discount: 35,
        bbs: "BBS Price 1199",
    },
    {
        ...
        imgsrc: "/prodimg/women t-shirts/wtshirts9.jpg",
        price: 1039,
        op: 1599,
        discount: 35,
        bbs: "BBS Price 959",
    },
    {
        ...
        imgsrc: "/prodimg/women t-shirts/wtshirts10.jpg",
        price: 1585,
        op: 2599,
        discount: 39,
        bbs: "BBS Price 1429",
    },
    {
        ...
        imgsrc: "/prodimg/women t-shirts/wtshirts11.jpg",
        price: 1043,
        op: 1799,
        discount: 42,
        bbs: "BBS Price 900",
    },
    {
        ...
        imgsrc: "/prodimg/women t-shirts/wtshirts12.jpg",
        price: 1007,
        op: 1599,
        discount: 37,
        bbs: "BBS Price 879",
    },
    {
        brand: "Puma",
        type: "Brand Print Crew-Neck T-shirt",
        imgsrc: "/prodimg/women t-shirts/wtshirts13.jpg",
        price: 1199,
        op: 1999,
        discount: 40,
        bbs: "BBS Price 899",
    },
    {
        ...
        imgsrc: "/prodimg/women t-shirts/wtshirts14.jpg",
        price: 1349,
        op: 1799,
        discount: 25,
        bbs: "BBS Price 1223",
    },
    {
        brand: "TOMMY HILFIGER",
        type: "Brand Print Crew-Neck T-shirt",
        imgsrc: "/prodimg/women t-shirts/wtshirts15.jpg",
        price: 1689,
        op: 2599,
        discount: 35,
        bbs: "BBS Price 1559",
    },
    {
        ...
        imgsrc: "/prodimg/women t-shirts/wtshirts16.jpg",
        price: 4199,
        op: 5999,
        discount: 30,
        bbs: "BBS Price 3419",
    },
    {
        ...
        imgsrc: "/prodimg/women t-shirts/wtshirts17.jpg",
        price: 520,
        op: 1299,
        discount: 60,
        bbs: "BBS Price 442",
    },
    {
        ...
        imgsrc: "/prodimg/women t-shirts/wtshirts18.jpg",
        price: 927,
        op: 1599,
        discount: 42,
        bbs: "BBS Price 800",
    },
    {
        ...
        imgsrc: "/prodimg/women t-shirts/wtshirts19.jpg",
        price: 1097,
        op: 1799,
        discount: 39,
        bbs: "BBS Price 989",
...
<div id="scbrandcat">
    ...
    <div>
    <input type="checkbox" name="Puma"   onclick="john(data)"  id="">
    <label for="">Puma</label>
    </div>

    <div>
    <input type="checkbox" name="TOMMY HILFIGER"    onclick="campus(data)" id="">
    <label for="">TOMMY HILFIGER</label>
    </div>

    <div>
    <input type="checkbox" name="Teamspirit"   onclick="us(data)"  id="">
    <label for="">Teamspirit</label>
    </div>

    <div>
    <input type="checkbox" name="ARMANI EXCHANGE"   onclick="tbase(data)"   id="">
    <label for="">ARMANI EXCHANGE</label>
    </div>

    <div>
    <input type="checkbox" name="FIG"   onclick="columbia(data)"    id="">
    <label for="">FIG</label>
    </div>

    <div>
    <input type="checkbox" name="LEVIS"onclick="nike(data)" id="">
...
let  campus= (data) => {
  ...
  if (campus1 % 2 == 0) {
    ...
    let arr1 = [];
    data.forEach((element) => {
      if (element.brand ==="TOMMY HILFIGER") {
         arr1.push(element);
      }
    });
    scjsgrid1.innerHTML = "";
...
let  tbase= (data) => {
  ...
  if (tbase1 % 2 == 0) {
    ...
    let arr1 = [];
    data.forEach((element) => {
      if (element.brand ==="ARMANI EXCHANGE") {
         arr1.push(element);
      }
    });
    scjsgrid1.innerHTML = "";
