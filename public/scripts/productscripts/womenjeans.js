...
async function brand2api(gender,type) {
  try {
    const underapi = await fetch(`https://ajio-clone-full.herokuapp.com/filterbybrand/${gender}/${type}/Outryt`);
...
async function brand4api(gender,type) {
  try {
    const underapi = await fetch(`https://ajio-clone-full.herokuapp.com/filterbybrand/${gender}/${type}/ORCHIDBLUES`);
...
async function brand5api(gender,type) {
  try {
    const underapi = await fetch(`https://ajio-clone-full.herokuapp.com/filterbybrand/${gender}/${type}/DENIZENWOMENS`);
...
async function brand6api(gender,type) {
  try {
    const underapi = await fetch(`https://ajio-clone-full.herokuapp.com/filterbybrand/${gender}/${type}/DolceCrudo`);
