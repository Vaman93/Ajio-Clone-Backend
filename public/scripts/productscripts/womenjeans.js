...
async function brand2api(gender,type) {
  try {
    const underapi = await fetch(`http://localhost:2222/filterbybrand/${gender}/${type}/Outryt`);
...
async function brand4api(gender,type) {
  try {
    const underapi = await fetch(`http://localhost:2222/filterbybrand/${gender}/${type}/ORCHIDBLUES`);
...
async function brand5api(gender,type) {
  try {
    const underapi = await fetch(`http://localhost:2222/filterbybrand/${gender}/${type}/DENIZENWOMENS`);
...
async function brand6api(gender,type) {
  try {
    const underapi = await fetch(`http://localhost:2222/filterbybrand/${gender}/${type}/DolceCrudo`);
